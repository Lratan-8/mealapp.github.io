...
// this piece of code stores the favourite item in the local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// this code fetch meal details from the given API
...
// this code diplays all the meals corresponding to the letter of the pressed key
...
//this code shows all the meal details without reloading the page
...
// to show meals in the favourites section
...
//to add and remove meal from the favourite's list
